...
$messages['pl'] = array(
	...
	'massmessage-submitted' => 'Zlecenie dostarczenia twojej wiadomości do {{PLURAL:$1|$1 strony|$1 stron}} zostało umieszczone w kolejce.',
	...
	'massmessage-parse-badurl' => '„$1” nie jest poprawną witryną.',
	...
	'log-name-massmessage' => 'Rejestr wiadomości masowych',
	...
	'massmessage-cannot-rename' => 'To jest konto systemowe i jego nazwa nie może być zmieniona.',
);
...
$messages['sv'] = array(
	...
	'massmessage-optout-category' => 'Valde bort meddelandeleverans',
	'massmessage-badhtml' => 'Ditt meddelande kan ha {{PLURAL:$2|en oavslutad HTML-tagg|oavslutade HTML-taggar}}: $1.',
...
$messages['vi'] = array(
	...
	'massmessage-form-header' => 'Hãy điền biểu mẫu sau để nhắn tin cho một danh sách được định rõ. Tất cả các trường là bắt buộc ([https://www.mediawiki.org/wiki/Special:MyLanguage/Help:Extension:MassMessage tìm hiểu thêm]).',
...
$messages['zh-hans'] = array(
	...
	'massmessage-submitted' => '你要递送至{{PLURAL:$1|$1个页面}}的信息已经加入队列。',
	...
	'massmessage-queued-count' => '队列中的[[Special:MassMessage|群发信息]]',
	'massmessage-hidden-comment' => '<!-- 消息发送者 User:$1@$2，使用的列表为 $3 -->',
	'massmessage-optout-category' => '不接受信息递送',
	...
	'log-description-massmessage' => '这些事件追踪发送信息的用户。',
	'logentry-massmessage-send' => '$1{{GENDER:$2|发送信息}}至$3',
	'logentry-massmessage-failure' => '“$4”至$3的递送失败，错误代码为<code>$5</code>',
	'logentry-massmessage-skipbadns' => '“$4”至$3的递送已跳过，因为目标处于无法张贴的名字空间',
	'logentry-massmessage-skipoptout' => '“$4”至$3的递送已跳过，因为目标已经拒绝信息递送',
	'logentry-massmessage-skipnouser' => '“$4”至$3的递送已跳过，因为用户账户不存在',
	'massmessage-cannot-rename' => '这是一个系统账户，不能被重命名。',
	'massmessage-nextsteps' => '[[Special:MassMessage|发送其他信息]]或[[Special:Statistics|查看队列中的信息的数量]]。',
);
